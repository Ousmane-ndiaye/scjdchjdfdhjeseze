...
$this->services['App\Controller\SecurityController'] = $instance = new \App\Controller\SecurityController(($this->services['router'] ?? $this->getRouterService()), new \Symfony\Component\Security\Core\Security(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.authorization_checker' => function () {
...
}))), ($this->services['session'] ?? $this->getSessionService()));
