...
$this->services['App\Controller\SecurityController'] = $instance = new \App\Controller\SecurityController(($this->services['router'] ?? $this->getRouterService()), ($this->privates['security.helper'] ?? $this->load('getSecurity_HelperService.php')), ($this->services['session'] ?? $this->getSessionService()));
